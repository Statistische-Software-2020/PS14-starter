...
1) Read chapters on loops, conditionals, and functions in R4DS.
The links can be accessed via [Moodle](https://moodle.lmu.de/course/view.php?id=8020)
...
Have a look at the following simulated data set:
...
E.g. a vector reporting height in cm

```{r echo = FALSE}
height <- c(156, 189, 177, 160, 182, 178)
height
```
...
c) Use the `apply` family (`lapply`) family to vectorise your solution from b).
